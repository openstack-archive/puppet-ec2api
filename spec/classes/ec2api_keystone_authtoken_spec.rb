...
describe 'ec2api::keystone::authtoken' do
  ...
  shared_examples 'ec2api::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('ec2api_config').with(
          :username                       => 'ec2api',
          :password                       => 'ec2api_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'ec2api::keystone::authtoken'
    end
  end
